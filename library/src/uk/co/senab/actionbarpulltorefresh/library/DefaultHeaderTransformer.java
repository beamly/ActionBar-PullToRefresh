...
public class DefaultHeaderTransformer extends HeaderTransformer {
	...
	private void applyProgressBarSettings() {
		if (mHeaderProgressBar != null) {
			...
			mHeaderProgressBar.setIndeterminateDrawable(new SmoothProgressDrawable.Builder(mHeaderProgressBar.getContext()).color(mProgressDrawableColor).strokeWidth(strokeWidth).build());
